    ...
    return (
        ...
        <div className="bg-neutral-50 p-2 w-full">
            <div className="grid grid-cols-5">
                <div className="col-span-1 overflow-hidden"><span className="text-base lt-sm:text-sm text-neutral-900 font-semibold">{payment.is_upi ? "UPI" : payment.bank_name}</span></div>
                <div className="col-span-1 overflow-hidden"><span className="text-base lt-sm:text-sm text-neutral-900">{payment.is_upi ? "UPI" : payment.ifsc}</span></div>
                <div className="col-span-2 overflow-hidden px-2 text-right"><span className="text-base lt-sm:text-sm text-neutral-900">{payment.is_upi ? payment.upi : payment.account_number}</span></div>

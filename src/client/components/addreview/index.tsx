...
function StarIcon(props: any) {
    ...
    return (
        ...
        <svg aria-hidden="true" className="w-6 h-6" fill={fill} stroke="#327251" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
    );
}
...
export const AddReview: React.FC<Props> = ({ product_id, callback, review }) => {
    ...
    useEffect(() => {
        setState({ comment: review?.comment, rating: review?.rating, id: review?.id, product_id: product_id })
    }, [review])

    return (
        <div className="grid grid-rows w-full p-2 bg-sky-100">
            {

                review == null || updateMode ?
                    <>
                        <div>
                            <h4 className="text-lg px-3 text-success-500 font-bold">Write a review</h4>
                        </div>
                        ...
                        <div className="p-2">
                            <button id="feedbackBtn" onClick={() => handleAddReview()}
                                className="bg-success-400 text-neutral-50 text-center mx-auto active:bg-success-500 text-sm uppercase py-2 px-4 rounded shadow hover:shadow-lg outline-none focus:outline-none"
                                type="submit">Submit
                            </button>
                    ...
                    <>
                        <div> <h4 className="text-xl mb-4 text-neutral-600 font-semibold">Your Review</h4>
                                ...
                                <div className="grid grid-row grid-flow-col">
                                    <div className="flex justify-start gap-2">
                                        ...
                                        <span className="flex justify-end ">
                                            <div className="rating flex flex-row h-6 gap-0.5 bg-success-500 border-solid border-2 border-success-500  shadow-md rounded-md px-1 w-max ">

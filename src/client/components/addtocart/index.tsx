...
export const AddToCart = ({ product, inventory, addToCartBag = true, btnStyle }: Props) => {
    ...
    return (
        <>
            {
                getLength(product?.variants) > 1 ? <CartButtonV2 product={product} inventory={inventory as TInventory} mode={""} btnStyle={btnStyle}></CartButtonV2> : <CartButton Isvariant={false} product={product} inventory={inventory as TInventory} mode={""} btnStyle={btnStyle}></CartButton>
            }

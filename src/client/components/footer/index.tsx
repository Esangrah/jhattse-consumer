...
export const Footer = () => {
    return (
        <div className="flex flex-col justify-center p-4 gap-4 w-full bg-black font-manrope">
            <div className="flex flex-row justify-between block sm:hidden">
                <div className="flex flex-col justify-start gap-2">
                    ...
                    <div className="text-white font-semibold select-none">Follow Us</div>
                    <div className="flex flex-row items-center gap-2">
                        <div className="text-sm hover:font-semibold select-none text-white"><Link href={'https://twitter.com/jhattse'}><AiOutlineTwitter /></Link></div>
                        <div className="text-sm hover:font-semibold select-none text-white"><Link href={'https://www.facebook.com/profile.php?id=100088066437195'}><GrFacebookOption /></Link></div>
                        <div className="text-sm hover:font-semibold select-none text-white"><Link href={'https://www.instagram.com/jhattse/'}><AiOutlineInstagram /></Link></div>
                        <div className="text-sm hover:font-semibold select-none text-white"><Link href={`https://www.google.com/maps/place/ESANGRAH+TECHNOLOGIES+PRIVATE+LIMITED/@30.2977277,78.0679105,17z/data=!3m1!4b1!4m6!3m5!1s0x390929a02dbc9563:0x483f9a088c2712a1!8m2!3d30.2977231!4d78.0700992!16s%2Fg%2F11sjgmr_fg`}><FaMapMarkerAlt /></Link></div>
                    </div>
                </div>
                <div className="flex flex-row justify-end gap-10 text-white">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="text-sm hover:font-semibold"><Link href="mailto:contact@esangrah.com" className="flex flex-row items-center gap-1"><HiOutlineMail size="1.5em" />contact@esangrah.com</Link></div>
            ...
            <div className="text-white text-center text-xs h-1/4 w-full flex flex-col justify-end">{`@Copyright ${new Date().getFullYear()} Esangrah Technologies Pvt Ltd`}</div>
        </div>
    );
};

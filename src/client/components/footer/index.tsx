            ...
            <div className="flex flex-row justify-between block sm:hidden">
                <div className="flex flex-col justify-start gap-2">
                    ...
                    <div className="flex flex-row items-center gap-2">
                        <div className="text-sm hover:font-semibold select-none text-white"><Link to={'https://twitter.com/jhattse'}><AiOutlineTwitter /></Link></div>
                        <div className="text-sm hover:font-semibold select-none text-white"><Link to={'https://www.facebook.com/profile.php?id=100088066437195'}><GrFacebookOption /></Link></div>
                        <div className="text-sm hover:font-semibold select-none text-white"><Link to={'https://www.instagram.com/jhattse/'}><AiOutlineInstagram /></Link></div>
                        <div className="text-sm hover:font-semibold select-none text-white"><Link to={`https://www.google.com/maps/place/ESANGRAH+TECHNOLOGIES+PRIVATE+LIMITED/@30.2977277,78.0679105,17z/data=!3m1!4b1!4m6!3m5!1s0x390929a02dbc9563:0x483f9a088c2712a1!8m2!3d30.2977231!4d78.0700992!16s%2Fg%2F11sjgmr_fg`}><FaMapMarkerAlt /></Link></div>
                    </div>
                </div>

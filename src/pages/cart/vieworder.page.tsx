            ...
            <Container>
                ...
                <>
                    {orderDetails?.map((order: TOrder) => {
                        return (
                            <div key={order?.id} className='px-20 lt-sm:px-4 font-manrope flex flex-col grow justify-between'>
                                <div>
                                    <div className='flex flex-col gap-2'>
                                        <div><h1 className="font-bold text-lg text-custom_black font-manrope 
                lt-sm:text-base">Order #{order?.short_id}</h1></div>
                                        <div><h1 className="font-bold text-lg text-custom_black font-manrope 
                lt-sm:text-base">{order?.store?.name}</h1></div>

            ...
            <div className="px-20 sm:px-0 font-manrope">
                <div className="hidden sm:block">
                    ...
                    <div className="bg-neutral-50 grid gap-4 p-4">
                        ...
                        <Link href={'/order/me'}><div className="flex flex-flow-row gap-2 items-center"><span><FaBox /></span><p className="font-base text-base text-neutral-900">My Orders</p></div></Link>
                    </div>
                    <div className="h-4"></div>
                    <div className="grid gap-4 bg-neutral-50 p-4">
                        <div><p className="font-bold text-xl text-neutral-900">Account Settings</p></div>
                        <Link href={'./account/profile'}><div className="flex flex-flow-row gap-2 items-center"><span><FaRegUser /></span><span>Edit Profile</span></div></Link>
